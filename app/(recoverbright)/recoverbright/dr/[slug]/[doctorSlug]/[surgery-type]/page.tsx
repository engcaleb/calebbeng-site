...
type Params = Promise<{ slug: string; doctorSlug: string; "surgery-type": string }>;

export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  const { slug, doctorSlug, "surgery-type": surgerySegment } = await params;
  const page = await getPublishedPage(slug, doctorSlug, surgerySegment);
